...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="type_endpoint">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Точка А" value="point_a"/>
        <value key="Точка Б" value="point_b"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="status_measure">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Не проведено" value="not_measure"/>
        <value key="Проведено" value="measure"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="Hidden" name="status_measure_ch">
      <widgetv2config fieldEditable="1" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 attr="type_endpoint" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="point_a" label="Точка А"/>
      <category render="true" symbol="1" value="point_b" label="Точка Б"/>
      <category render="true" symbol="2" value="" label="Неопределено"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="symbol/red-marker.svg"/>
          <prop k="offset" v="-0.4,-9.6"/>
        ...
        <layer pass="0" class="FontMarker" locked="0">
          ...
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="offset" v="-0.2,-8"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="size" v="4.94845"/>
          <prop k="size_map_unit_scale" v="0,0"/>
          <prop k="size_unit" v="MM"/>
          <prop k="vertical_anchor_point" v="1"/>
        </layer>
  ...
  <aliases>
    ...
    <alias field="status_check_ch" index="5" name="Дата изменения статуса проверки"/>
    <alias field="status_measure" index="2" name="Статус измерения"/>
    <alias field="status_measure_ch" index="3" name="Дата изменения статуса"/>
    <alias field="type_endpoint" index="1" name="Тип"/>
  </aliases>
