...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{c25f125b-5742-4dcf-97f1-e72df3d67a63}">
      <rule filter="&quot;status_built&quot;  = 'project'  or &quot;status_built&quot;  IS NULL " key="{c35c1ff9-ac4f-4770-b5d8-d41692e14dda}" symbol="0" label="Проект"/>
      <rule filter="&quot;status_built&quot;  = 'built' " key="{3f636a2f-9be7-486b-b583-a9afa2569399}" symbol="1" label="Построен"/>
    </rules>
    <symbols>
  ...
  <aliases>
    <alias field="address" index="1" name="Адрес установки"/>
    ...
    <alias field="status_built_ch" index="3" name="Дата изменения статуса строительства"/>
