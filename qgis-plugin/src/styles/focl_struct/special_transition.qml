...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="special_laying_method">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="ГНБ" value="hdd"/>
        <value key="На опорах" value="towers"/>
        <value key="По дну водоема" value="bottom"/>
      </widgetv2config>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="132,63,174,255"/>
  ...
  <aliases>
    ...
    <alias field="special_laying_method" index="1" name="Способ прокладки кабеля"/>
  </aliases>
