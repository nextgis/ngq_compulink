...
<qgis version="2.6.0-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="type_fosc">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Разветвительная" value="separate"/>
        <value key="Соединительная" value="union"/>
      </widgetv2config>
    </edittype>
    <edittype widgetv2type="ValueMap" name="fosc_placement">
      <widgetv2config fieldEditable="1" labelOnTop="0">
        <value key="Грунт" value="ground"/>
        <value key="Другое" value="other"/>
        <value key="Колодец" value="well"/>
        <value key="Опора" value="pylon"/>
        <value key="Помещение" value="room"/>
        <value key="Шкаф" value="cabinet"/>
      </widgetv2config>
    </edittype>
  </edittypes>
  <renderer-v2 attr="existing" symbollevels="0" type="categorizedSymbol">
    ...
    <source-symbol>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="101,145,168,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
  ...
  <aliases>
    ...
    <alias field="fosc_placement" index="4" name="Место размещения"/>
    <alias field="name" index="0" name="Наименование"/>
    <alias field="type_fosc" index="3" name="Тип"/>
  </aliases>
