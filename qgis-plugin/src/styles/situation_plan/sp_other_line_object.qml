...
<qgis version="2.6.0-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueMap" name="type_sp_other_line">
  ...
  <renderer-v2 attr="type_sp_other_line" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="" label="Не попределен"/>
    </categories>
    <symbols>
      <symbol alpha="0.454902" type="line" name="0">
  ...
  <aliases>
    ...
    <alias field="type_sp_other_line" index="1" name="Тип"/>
  </aliases>
